...
public class ContaReceber {
    ...
    private com.praticapro.sieduardoseixas2026.notasaida.NotaSaida notaSaida;
    ...
    public void prePersist() {
        ...
        if (this.valorRecebido == null) this.valorRecebido = BigDecimal.ZERO;
    }
    ...
    public BigDecimal getSaldo() {
        return getValorAtualizado().subtract(valorRecebido == null ? BigDecimal.ZERO : valorRecebido);
    }
