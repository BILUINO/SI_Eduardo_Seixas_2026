...
@Data
@Entity
@Table(name = "tb_nota_entrada", uniqueConstraints = {
        @UniqueConstraint(name = "uk_nota_entrada_num_serie_forn",
                columnNames = {"numero", "serie", "fornecedor_id"})
})
public class NotaEntrada {
    ...
    @OneToMany(mappedBy = "notaEntrada", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
    @JsonManagedReference("nota-entrada-item")
    ...
    public void calcularTotais() {
        ...
        BigDecimal soma = this.valorProdutos
